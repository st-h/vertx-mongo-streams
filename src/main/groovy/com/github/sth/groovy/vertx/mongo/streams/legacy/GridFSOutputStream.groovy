package com.github.sth.groovy.vertx.mongo.streams.legacy
...
class GridFSOutputStream implements AsyncOutputStream {
    ...
    private final def com.github.sth.vertx.mongo.streams.legacy.GridFSOutputStream delegate;

    public GridFSOutputStream(Object delegate) {
        this.delegate = (com.github.sth.vertx.mongo.streams.legacy.GridFSOutputStream) delegate;
    }
    ...
    public static GridFSOutputStream create(WriteStream<Buffer> writeStream) {
        def ret = InternalHelper.safeCreate(com.github.sth.vertx.mongo.streams.legacy.GridFSOutputStream.create(
